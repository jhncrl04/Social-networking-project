...
public class ReportPost extends AppCompatActivity {
    ...
    String reportTitle, reportDetail, postId, uid, authorId;
    ...
    public void submitReport(String title, String detail, String postId, String uid, String authorId) {
        ...
        newDoc.put("reportType", "Post Report");
        ...
        newDoc.put("authorID", authorId);
        newDoc.put("reporterID", uid);
        newDoc.put("reportDate", date);

        docRef.set(newDoc)
                .addOnSuccessListener(unused -> {
                    Toast.makeText(ReportPost.this, "Report submitted successfully", Toast.LENGTH_SHORT).show();
